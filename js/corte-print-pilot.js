...
// Reutiliza la ruta interna de impresión para evitar window.open en Electron.
// ============================================
...
(function () {
  ...
  window.imprimirCorteCompleto = async () => {
    try {
      const hoy = new Date();
      ...
      await window.LotoPilotPrint.printInFrame(html, width);
    } catch (error) {
  ...
  console.log('✅ Corte de caja: impresión sin popup activa');
})();
