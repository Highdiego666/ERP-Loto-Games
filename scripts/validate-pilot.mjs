...
if (!html.includes('js/stability-fixes-v1.js')) throw new Error('La capa de estabilización no está cargada');
...
if (stability.includes('window.open(')) throw new Error('La impresión del piloto no debe depender de popups');
...
console.log('✅ Pilot checks OK: runtime limpio, edición protegida, impresión sin popup y Traspasos reproducible');
